...
API для социальной сети Yatube — платформы для публикации постов и взаимодействия с контентом.
...
- Аутентифицироваться по JWT-токену
- Работать с комментариями и группами (если реализовано)

API поддерживает методы `GET`, `POST`, `PUT`, `PATCH`, `DELETE` и возвращает данные в формате `JSON`.
