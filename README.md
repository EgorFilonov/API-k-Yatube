...
1. Выполнить POST-запрос  к эндпоинту ```http://127.0.0.1:8000/api/v1/jwt/create/```  передать в него поле username и password
...
### Результат POST-запроса ```http://127.0.0.1:8000/api/v1/posts/``` с auth-токеном для добавления групп пользователем: 
